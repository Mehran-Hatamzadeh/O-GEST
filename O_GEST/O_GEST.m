...
if width(JointsDepth_L)==1
    try
        ...
        [INFO_L1,INFO_R1] = GEST_OneLandmark (Time,JointsDepth_L,JointsDepth_R,Setting);
...
elseif width(JointsDepth_L)==2
    try
        ...
        [INFO_L1,INFO_R1] = GEST_OneLandmark (Time,JointsDepth_L(:,1),JointsDepth_R(:,1),Setting);
        cprintf('*blue',   'Optimizing Second Landmark Pair\n');
        [INFO_L2,INFO_R2] = GEST_OneLandmark (Time,JointsDepth_L(:,2),JointsDepth_R(:,2),Setting);
...
elseif width(JointsDepth_L)==3
    try
        ...
        [INFO_L3,INFO_R3] = GEST_OneLandmark (Time,JointsDepth_L(:,3),JointsDepth_R(:,3),Setting);
