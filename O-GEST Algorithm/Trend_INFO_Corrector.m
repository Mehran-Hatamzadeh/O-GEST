...
INFO.Sections_Smoothed=info.Sections_Smoothed;
if Setting.Direction=="Upward"
    for i=1:1:width(INFO.Sections_Smoothed)
        sec_smooth=INFO.Sections_Smoothed{1,i};
        INFO.Sections_Smoothed{1,i}=[sec_smooth(:,1),-sec_smooth(:,2)];
    end
end
end